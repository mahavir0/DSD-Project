	...
	public static void patientTask(String id) throws IOException {
		...
		while (true) {
			...
			if (ch.equals("1")) {
				...
				clientLogger(patientID, "Book Appointment", patientID + " " + appointmentID + " " + appointmentType,
						result);
			} else if (ch.equals("2")) {
				String result = "";
				...
				String result = "";
				result = damsobj.swapAppointment(patientID, appointmentID, appointmentType, newAppointmentID,
						newAppointmentType);
				System.out.println(result);
				clientLogger(patientID, "Swap Appointment", patientID + " " + appointmentID + " " + appointmentType
						+ " " + newAppointmentID + " " + newAppointmentType, result);
			} else if (ch.equals("0")) {
				break;
			} else {
	...
	public static void adminTask(String id) throws IOException {
		...
		while (true) {
			...
			if (ch.equals("1")) {
				...
				System.out.println(result);
				clientLogger(id, "Add Appointments", id + " " + appointmentID + " " + appointmentType + " " + cap,
						result);
			} else if (ch.equals("2")) {
				System.out.println("Enter the Appointment ID : ");
				appointmentID = sc.next().toUpperCase();
				...
				result = damsobj.swapAppointment(patientID, appointmentID, appointmentType, newAppointmentID,
						newAppointmentType);
				System.out.println(result);
				clientLogger(id, "Swap Appointment", patientID + " " + appointmentID + " " + appointmentType + " "
						+ newAppointmentID + " " + newAppointmentType, result);
			} else if (ch.equals("0")) {
				break;
			} else {
