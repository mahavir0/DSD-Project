...
public class Quebec {
	public static QUEImpl queImpl;
	public static QUEImpl backupQueImpl;
	...
	public static void receiveRequestFromReplicaManager(QUEImpl queobj) {
		...
		try {
			...
			System.out.println("UDP Server for Quebec is running on port : 2002");
			while (true) {
				...
				if (func.equals("addAppointment")) {
					...
					result = queobj.swapAppointment(parameters.get(0), parameters.get(1), parameters.get(2),
					...
					backupQueImpl = new QUEImpl();
					queImpl = backupQueImpl;
				}
