...
public class Quebec{
	...
	public static void receive(Quebec_Class mon) {
		...
		try {
			...
			System.out.println("QC_udp_server started 3333");
			while(true){
	...
	//  operation+";"+userid+";"+appointmentType+";"+appointmentId+";"+capacity+";"+newAppointmentID+";"+newAppointmentType;	
				...
				System.out.println("Send dataaaaaaaaaaaaaaaaaaaa + :   "+send_data);
	...
	public static void receiveRequestFromReplicaManager(Quebec_Class mtlobj) {
		 String result= "";
		 DatagramSocket  ds=null;
		 try {
			 ds = new DatagramSocket(3334);
			 byte[] receive = new byte[100000];
			 System.out.println("UDP Server for QC is running on port : 3334");
			 while(true) {
